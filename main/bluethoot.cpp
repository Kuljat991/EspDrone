...
static void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_START_EVT:
        ...
        printf("START\n");
        write_handler = param->write.handle;
...
//        printf("%i \n", param->data_ind.data[1]);
    	//write_handler = param->write.handle;
        process_packet(param->data_ind.data, param->data_ind.len);
        break;
...
void bt_initialize()
{
	//esp_log_level_set(SPP_TAG, (esp_log_level_t)0);
	printf("Hello world!\n");
...
void bt_send_data(uint8_t *p_data, uint16_t len ){
	esp_spp_write(write_handler, len, p_data);
}
